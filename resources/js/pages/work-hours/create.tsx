...
export default function WorkHoursCreate() {
                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Isi detail jam operasional yang berlaku.
                        </p>
                    </div>
